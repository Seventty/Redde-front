...
export class ContactUs {
    ...
    get mapStyle() {
        return {
            'background-image': this.layoutService.isDarkTheme() ? "url('https://primefaces.org/cdn/v2/images/contact/map-dark.svg')" : "url('https://primefaces.org/cdn/v2/images/contact/map-light.svg')"
        };
    }
}
