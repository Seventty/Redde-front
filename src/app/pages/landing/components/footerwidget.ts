        ...
        <div class="flex items-center justify-between py-6" style="mix-blend-mode: multiply">
            <div class="flex items-center justify-between">
                <div class="flex items-center cursor-pointer" (click)="router.navigate(['/'])">
                    <img src="/images/logo-dark.png" alt="atlantis-layout" class="logo" style="height: 32px" />
                    <img src="/images/appname-dark.png" alt="atlantis-layout" class="appname ml-2" style="height: 12px" />
