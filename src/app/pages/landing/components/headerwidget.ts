...
@Component({
    ...
    template: ` <div id="header" class="landing-header flex flex-col w-full p-12" style="min-height: 1000px; background: url('/images/landing/landing-header-2x.jpg') top left no-repeat; background-size: cover">
        <div class="header-menu-container flex items-center justify-between">
            <div class="header-left-elements flex items-center justify-between">
                <div class="layout-topbar-logo flex items-center cursor-pointer" (click)="router.navigate(['/'])">
                    <img src="/images/logo-dark.png" alt="layout" style="height: 32px" />
                    <img src="/images/appname-dark.png" alt="layout" class="ml-2" style="height: 12px" />
                </div>
